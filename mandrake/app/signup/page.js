    ...
    <div className="w-full h-screen flex">
      <div className="w-[50%] bg-white flex flex-col h-full justify-center items-center cred-box z-1">
        ...
        <div className="w-[60%]">
          ...
          <input type="text" className="border-gray-400 border-2 w-full rounded-lg py-1 mb-5 text-sm text-center" placeholder="Enter your name" />
          ...
          <div className="flex justify-center gap-4 font-bold">
            <p className="">Already have an account?</p><Link className="text-blue-500" href={"/login"}>Sign in</Link>
          </div>
        </div>
      </div>
